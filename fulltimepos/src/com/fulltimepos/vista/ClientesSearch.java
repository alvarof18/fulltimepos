...
public class ClientesSearch extends JFrame{
	...
	private static final long serialVersionUID = -1240573661612287159L;
	    ...
	    private void initComponents() {
	         ...
	         cbBusqueda.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione", "Codigo", "Identificacion", "Nombre", "Estado" }));
	         ...
	         cabecera = new String[] {"Codigo", "Nombre ", "Identificacion", "Estado"};
